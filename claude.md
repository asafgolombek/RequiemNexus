...
- **Phase 20 technical polish — Waves 1–4 delivered** (2026-04-03): [`docs/plan-improvement.md`](docs/plan-improvement.md) — seed `ISeeder` pipeline, `IReferenceDataCache`, `ICharacterQueryService`, `IModifierProvider` / `IRiteActivationStrategy`, `CharacterDetails` partials + hub loading/toast patterns, `CharacterAdvancement` section components, `DanseMacabreTabs/`. **P3** (optional): remaining large Razor files — see §5 step 13 in that doc. Review log: [`docs/plan-improvement-review.md`](docs/plan-improvement-review.md).
