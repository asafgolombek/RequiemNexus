...
- **Phase 17 active 🔄:** Humanity & Conditions — wire Condition penalties into `ModifierService` / `TraitResolver`; degeneration UI. See `docs/mission.md`.
- **Phase 20 — The Global Embrace** is the **last planned phase** after the V:tR 2e **playability** arc on the roadmap: **14–16b** and **17–19** (see `docs/mission.md` — includes Humanity, edge systems, and the discipline acquisition chain).
