...
## 🧭 Active Phase: Phase 16b — The Discipline Engine (Power Activation)
...
- **Phase 16b active 🔄:** The Discipline Engine — `DisciplineActivationService`, `ActivationCost` value object, activation UI, pool resolution wired to dice feed. See `docs/phase16b-the-discipline-engine.md`.
- **Phase 17 ready (parallel):** Humanity & Conditions — independent of Phase 16b; can proceed on a separate branch.
...
- `docs/phase16b-the-discipline-engine.md` — **Active phase plan** — execution order, file paths, method signatures, and tests for Phase 16b.
