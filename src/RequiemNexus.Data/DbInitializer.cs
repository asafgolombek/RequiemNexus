...
{
    private const string ClanDaeva = "Daeva";
    private const string ClanGangrel = "Gangrel";
    private const string ClanMekhet = "Mekhet";
    ...
    public static async Task InitializeAsync(ApplicationDbContext context)
    {
        ...
        {
            new() { Name = ClanDaeva, Description = "The succubi, masters of passion and manipulation." },
            ...
            celerity.Powers.Add(new DisciplinePower { Name = "Celerity 2", Level = 2, Description = "Can take a reflexive dash action.", Cost = CostOneVitae });
            celerity.Powers.Add(new DisciplinePower { Name = "Celerity 3", Level = 3, Description = "Subtract from all incoming attack pools.", Cost = CostOneVitae });
            celerity.Powers.Add(new DisciplinePower { Name = "Celerity 4", Level = 4, Description = "Can ignore minor environmental hazards.", Cost = CostOneVitae });
            celerity.Powers.Add(new DisciplinePower { Name = "Celerity 5", Level = 5, Description = "Take two actions instead of one.", Cost = CostOneVitae });
            ...
            protean.Powers.Add(new DisciplinePower { Name = "Haven of Soil", Level = 2, Description = "Meld into the earth to rest safely.", Cost = CostOneVitae });
            protean.Powers.Add(new DisciplinePower { Name = "Beast's Skin", Level = 3, Description = "Transform into a predatory animal (wolf, bat).", Cost = CostOneVitae });
            protean.Powers.Add(new DisciplinePower { Name = "Shape of the Beast", Level = 4, Description = "Transform into a swarm or combat-beast.", Cost = CostOneVitae });
            protean.Powers.Add(new DisciplinePower { Name = "Primeval Miasma", Level = 5, Description = "Transform into mist.", Cost = CostOneVitae });

            var resilience = new Discipline { Name = "Resilience", Description = "Supernatural toughness." };
            resilience.Powers.Add(new DisciplinePower { Name = "Resilience 1", Level = 1, Description = "Add to Stamina and downgrade agg damage.", Cost = CostOneVitae });
            ...
            vigor.Powers.Add(new DisciplinePower { Name = "Vigor 2", Level = 2, Description = "Increase carrying capacity massively.", Cost = CostOneVitae });
            vigor.Powers.Add(new DisciplinePower { Name = "Vigor 3", Level = 3, Description = "Break down doors easily.", Cost = CostOneVitae });
            vigor.Powers.Add(new DisciplinePower { Name = "Vigor 4", Level = 4, Description = "Leap incredible distances.", Cost = CostOneVitae });
            vigor.Powers.Add(new DisciplinePower { Name = "Vigor 5", Level = 5, Description = "Strike with earth-shattering force.", Cost = CostOneVitae });
            ...
            var clanDisciplines = new List<ClanDiscipline>
            {
                ...
                new() { ClanId = clans.First(c => c.Name == ClanDaeva).Id, DisciplineId = disciplinesList.First(d => d.Name == "Celerity").Id },
                new() { ClanId = clans.First(c => c.Name == ClanDaeva).Id, DisciplineId = disciplinesList.First(d => d.Name == "Majesty").Id },
                new() { ClanId = clans.First(c => c.Name == ClanDaeva).Id, DisciplineId = disciplinesList.First(d => d.Name == "Vigor").Id },

                // Gangrel: Animalism, Protean, Resilience
                new() { ClanId = clans.First(c => c.Name == ClanGangrel).Id, DisciplineId = disciplinesList.First(d => d.Name == "Animalism").Id },
                new() { ClanId = clans.First(c => c.Name == ClanGangrel).Id, DisciplineId = disciplinesList.First(d => d.Name == "Protean").Id },
                new() { ClanId = clans.First(c => c.Name == ClanGangrel).Id, DisciplineId = disciplinesList.First(d => d.Name == "Resilience").Id },

                // Mekhet: Auspex, Celerity, Obfuscate
                new() { ClanId = clans.First(c => c.Name == ClanMekhet).Id, DisciplineId = disciplinesList.First(d => d.Name == "Auspex").Id },
                new() { ClanId = clans.First(c => c.Name == ClanMekhet).Id, DisciplineId = disciplinesList.First(d => d.Name == "Celerity").Id },
                new() { ClanId = clans.First(c => c.Name == ClanMekhet).Id, DisciplineId = disciplinesList.First(d => d.Name == "Obfuscate").Id },

                // Nosferatu: Nightmare, Obfuscate, Vigor
                new() { ClanId = clans.First(c => c.Name == ClanNosferatu).Id, DisciplineId = disciplinesList.First(d => d.Name == "Nightmare").Id },
                new() { ClanId = clans.First(c => c.Name == ClanNosferatu).Id, DisciplineId = disciplinesList.First(d => d.Name == "Obfuscate").Id },
                new() { ClanId = clans.First(c => c.Name == ClanNosferatu).Id, DisciplineId = disciplinesList.First(d => d.Name == "Vigor").Id },
