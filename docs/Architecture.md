...
This section records a **static** review (no live trace), aligned with Phase 3 of the roadmap. Re-run profiling after major UI or schema changes.
...
- Avoid N+1: use `.Include()` / projections per this document’s query rules.
