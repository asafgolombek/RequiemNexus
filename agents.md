...
3. For **Phase 20 performance / refactor / UI-consistency** work, read [`docs/plan-improvement.md`](./docs/plan-improvement.md) — use **Wave** sequencing there; do not confuse Waves with mission phase numbers.
